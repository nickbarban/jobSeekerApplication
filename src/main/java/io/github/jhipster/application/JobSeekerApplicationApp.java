...
public class JobSeekerApplicationApp {

    private static final Logger log = LoggerFactory.getLogger(JobSeekerApplicationApp.class);

    private final Environment env;

    public JobSeekerApplicationApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes jobSeekerApplication.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(JobSeekerApplicationApp.class);
